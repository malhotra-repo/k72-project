...
const Agence = () => {
  ...
  return (
    <div className="">
      <div
        ref={imageDivRef}
        className="absolute overflow-hidden lg:h-[20vw] h-[30vw] lg:rounded-3xl rounded-xl lg:top-96 -top-80 lg:left-[30vw] left-[30vw]"
      >
        <img
          ref={imageRef}
      ...
      <div className="font-[font2]">
        ...
        <div className="pl-[40%]  mt-20 mt-4 p-3">
